...
int main() {
    ...
    const int      LARGE_PIZZA_DIA = 24;
    const int      LARGE_PIZZA_SERVES = 9;

    const double   MED_PIZZA_PRICE = 13.25;
    const int      MED_PIZZA_DIA = 18;
    const int      MED_PIZZA_SERVES = 5;

    const double   SMALL_PIZZA_PRICE = 8.39;
    const int      SMALL_PIZZA_DIA = 14;
    const int      SMALL_PIZZA_SERVES = 2;
